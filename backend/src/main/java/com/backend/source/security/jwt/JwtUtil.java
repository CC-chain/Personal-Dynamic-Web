...
public class JwtUtil {
	...
	public String createToken(Authentication authentication) {
		...
		return Jwts.builder().setId(Long.toString(customUserDetails.getId()))
				.setSubject(customUserDetails.getUsername()).setIssuedAt(new Date()).claim("authoritites", authorities)
