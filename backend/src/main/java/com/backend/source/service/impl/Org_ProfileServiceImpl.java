...
import com.backend.source.repository.Org_ProfileRepository;
import com.backend.source.service.Org_ProfileService;

@Service
public class Org_ProfileServiceImpl implements Org_ProfileService{

	Org_ProfileRepository profileRepository;
	
	public Org_ProfileServiceImpl(Org_ProfileRepository profileRepository) {
		super();
